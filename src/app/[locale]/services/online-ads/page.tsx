...
function AdsPage() {
  const tServicePage = useTranslations("services.ads");
  ...
  const cardList: OfferCardList = [
    {
      pictureUrl: "/images/ads/meta.png",
    ...
    {
      pictureUrl: "/images/ads/google.png",
    ...
    {
      pictureUrl: "/images/ads/youtube.png",
    ...
    {
      pictureUrl: "/images/ads/analytics.png",
  ...
  return (
    <>
      <ServiceHero title={tServicePage("Hero.title")} subTitle={tServicePage("Hero.subTitle")} imageUrl={"/images/ads/ads.png"} />
...
export default withLocale(AdsPage);
